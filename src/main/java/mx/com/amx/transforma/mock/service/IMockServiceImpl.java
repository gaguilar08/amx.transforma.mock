...
public class IMockServiceImpl implements IMockService {
	...
	public List<Reclamo> consultaReclamo() {
		...
		Reclamo re1 = new Reclamo("000309", "Jockey club del Perú", parsedDate, "SGA", "Problema", "Facturación",
				"Concluido", " Reclamo primera instancia", "190259325", "Cerrado", "Productos corporativos",
				"Descartes realizados", "");
		
		Reclamo re2 = new Reclamo("000310", "Jockey club del Perú", parsedDate, "SGA", "Problema", "Facturación",
				"Concluido", " Reclamo primera instancia", "190259325", "Cerrado", "Productos corporativos",
				"Descartes realizados", "");
